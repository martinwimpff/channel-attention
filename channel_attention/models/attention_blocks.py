...
class SqueezeAndExcitation(nn.Module):
    def __init__(self, in_channels: int, reduction_rate: int, bias: bool = False):
        ...
        self.fc1 = nn.Conv2d(in_channels, int(in_channels // reduction_rate), 1,
                             bias=bias)
        self.nonlinearity = nn.ReLU()
        self.fc2 = nn.Conv2d(int(in_channels // reduction_rate), in_channels, 1,
                             bias=bias)
...
def get_attention_block(attention_mode: str, ch_dim: int = 16, reduction_rate: int = 4,
                        use_mlp: bool = False, seq_len: int = None, freq_idx: int = 0,
